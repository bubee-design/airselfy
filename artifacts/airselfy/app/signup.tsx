      ...
      >
        <View style={s.inner}>
          ...
          <View style={s.headerWrap}>
            ...
            <Text style={s.subtitle}>Join the community around you.</Text>
          </View>
          ...
          <View style={s.form}>
            <View style={s.field}>
              ...
              <View style={s.inputWrap}>
                <Feather name="user" size={16} color={colors.primary} style={s.inputIcon} />
                <TextInput
                  style={s.input}
                  value={name}
                ...
                <View style={s.strengthBar}>
                  {[1, 2, 3, 4].map((i) => (
                    <View
                      ...
                      style={[
                        s.strengthSegment,
                        { backgroundColor: strength >= i ? strengthColors[strength] : colors.muted },
                      ]}
                    />
                  ))}
                </View>
            ...
            <Pressable onPress={handleSignup} disabled={loading} style={{ marginTop: 8 }}>
              <LinearGradient
                colors={[colors.primary, colors.accent]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
